...
Обмен метками
По умолчанию, команда <font color="#c0504d">git push</font> не отправляет теги на удалённые сервера. После создания
теги нужно отправлять явно на удалённый сервер. Процесс аналогичен отправке
веток — достаточно выполнить команду <font color="#c0504d">git push origin <tagname>.</font>