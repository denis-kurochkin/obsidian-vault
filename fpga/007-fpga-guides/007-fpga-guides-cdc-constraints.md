...
```
1. synchronous related clocks
2. asynchronous clocks
3. logically exclusive clocks
4. physically exclusive clocks
5. clocks with known but complex relationship
```
...
```
если constraint говорит “это CDC”,
а структура не похожа на безопасный CDC,
Vivado может выдать warning.
```
