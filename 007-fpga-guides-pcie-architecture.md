...
```
DLLP — Data Link Layer PacketACK/NAKReplayFlow Control creditsLink-level reliability
```
...
```
serial lanesGT transceiversencoding/scramblinglane polaritylane reversallink speedlink widthelectrical behaviortraining sequences
```
